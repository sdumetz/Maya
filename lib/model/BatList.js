...
function BatList (){
  ...
  this.commerce= new Batiment({
    ...
    Le commerce consomme 20 unités d\'eau et 10 unités de bois. \
  ...
  this.monuments= new Batiment({
    ...
    image: "monument",
    menu: "monument",
    cout: {bois:500,calcaire:300,outils:100,pigments:100},
    ...
    La construction coûte 500 unités de bois, 300 unités de calcaire, 100 unités d\'outils et 100 unités de pigments.\
  ...
  this.jardin = new Batiment({
    ...
    image:"jardin",
    menu:"jardin",
    cout:{bois:500, calcaire:200,outils:100,pigments:200},
    ...
    La construction coûte 500 unités de bois, 200 unités de calcaire, 200 unités de pigments et 100 unités d\'outils.\
  ...
  this.champs = new Batiment({
    ...
    Le champs consomme 10 unités d\'eau.\
  ...
  this.atelier = new Batiment({
    ...
    consommation:{bois:10,outils:10,eau:20},
    ...
    L\'atelier consomme 10 unités de bois, 10 unités d\'outils et 10 unités d\'eau.\
